...
inline double gaussian_dist(double x_obs, double y_obs, double mu_x, double mu_y, double sig_x, double sig_y)
{
...
inline LandmarkObs transform(double x_part, double y_part, double theta, double x_obs, double y_obs, int id)
{
